...
const login = (req, res) => {
  ...
  const deleteSCLIById = async (req, res) => {
    ...
    //   const {id} = req.params
    //    try{
    //   const StuUpdated = await CLIENT.findByIdAndUpdate(id,{$set:{...req.body, password: await bcrypt.hash(password, 10),}})
    ...
    //   }
      ...
      const updateCLI = (req, res, next)=>{
        ...
        let updateData ={
          ...
          RS_CLIENT : req.body.RS_CLIENT,
          STATUT_CLIENT : req.body.STATUT_CLIENT,
          TEL_CLIENT : req.body.TEL_CLIENT,
          FAX_CLIENT:req.body.FAX_CLIENT,
          ANCA_CLIENT:req.body.ANCA_CLIENT,
          CAHT_CLIENT : req.body.CAHT_CLIENT,
          EFFECTIF_CLIENT : req.body.EFFECTIF_CLIENT,
          SYNDICAT_CLIENT : req.body.SYNDICAT_CLIENT,
          CAPITAL_CLIENT : req.body.CAPITAL_CLIENT,
          COD_APE_CLIENT : req.body.COD_APE_CLIENT,
          RCS_CLIENT : req.body.RCS_CLIENT,
          ACTIVITES_CLIENT : req.body.ACTIVITES_CLIENT,
          GIE_CLIENT : req.body.GIE_CLIENT,
          FILIALE_CLIENT : req.body.FILIALE_CLIENT,
          GROUPE_CLIENT : req.body.GROUPE_CLIENT,

          COMMENTAIRE_CLIENT : req.body.COMMENTAIRE_CLIENT,

          EVALUATION_CLIENT : req.body.EVALUATION_CLIENT,

          MQ_CLIENT : req.body.MQ_CLIENT,

          PG_CLIENT : req.body.PG_CLIENT,

          REGION_CLIENT : req.body.REGION_CLIENT,

          REPDIR_CLIENT : req.body.REPDIR_CLIENT,
